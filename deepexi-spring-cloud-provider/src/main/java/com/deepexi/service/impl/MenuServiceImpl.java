...
import com.deepexi.common.util.TreeUtil;
import com.deepexi.domain.entity.Menu;
import com.deepexi.domain.vo.CommonConstant;
import com.deepexi.domain.vo.Tree;
import com.deepexi.manager.UserManager;
import com.deepexi.mapper.MenuMapper;
import com.deepexi.service.MenuService;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    public Map<String, Object> findMenus(Menu menu) {
        ...
        try {
            ...
            result.put("ids", ids);
            if (StringUtils.equals(menu.getType(), CommonConstant.TYPE_BUTTON)) {
