...
import com.deepexi.common.util.MD5Util;
...
import com.deepexi.service.UserConfigService;
...
public class UserController extends BaseController {
    ...
    public void resetPassword(@NotBlank(message = "{required}") String usernames) throws SystemException {
        try {
    ...
    public void export(QueryRequest queryRequest, User user, HttpServletResponse response) throws SystemException {
        try {
