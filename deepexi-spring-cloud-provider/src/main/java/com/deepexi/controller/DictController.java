...
import com.deepexi.common.annotation.Log;
...
import com.deepexi.service.DictService;
...
public class DictController extends BaseController {
    ...
    public void addDict(@Valid Dict dict) throws SystemException {
        try {
    ...
    public void deleteDicts(@NotBlank(message = "{required}") @PathVariable String dictIds) throws SystemException {
        try {
    ...
    public void updateDict(@Valid Dict dict) throws SystemException {
        try {
    ...
    public void export(QueryRequest request, Dict dict, HttpServletResponse response) throws SystemException {
        try {
